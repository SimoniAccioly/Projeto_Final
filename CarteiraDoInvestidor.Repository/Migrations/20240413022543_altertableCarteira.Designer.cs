...
namespace CarteiraDoInvestidor.Repository.Migrations
{
    ...
    [Migration("20240413022543_altertableCarteira")]
    partial class altertableCarteira
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AtivosCarteiras", b =>
                {
                    b.Property<Guid>("CarteirasId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ListaDeAtivosId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("CarteirasId", "ListaDeAtivosId");

                    b.HasIndex("ListaDeAtivosId");

                    b.ToTable("AtivosCarteiras");
                });
            ...
            modelBuilder.Entity("AtivosCarteiras", b =>
                {
                    ...
                    b.HasOne("CarteiraDoInvestidor.Domain.Carteira.Agreggates.Ativos", null)
                        .WithMany()
                        .HasForeignKey("ListaDeAtivosId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
